...
1.  K-means clustering
    -   Requires you to choose a value for K. There isn't any commonly used value, but you can bring in a subject matter expert to help determine the best value for a specific set of data
2.  Hierarchical clustering
    -   Advantage over k-means clustering in that you don't have to specify the number of clusters in advance
    -   Results in a tree based diagram called a dendrogram
